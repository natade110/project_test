    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-white p-4">
      <div className="w-full max-w-md p-8 bg-white rounded-lg shadow-custom">
        ...
        <form onSubmit={handleSubmit}>
            ...
            <div>
              <label htmlFor="firstName" className="block text-sm font-bold mb-1">First Name <span className="text-secondary">*</span></label>
              <input
                type="text"
                id="firstName"
                name="firstName"
            ...
            <div>
              <label htmlFor="lastName" className="block text-sm font-bold mb-1">Last Name <span className="text-secondary">*</span></label>
              <input
                type="text"
                id="lastName"
                name="lastName"
